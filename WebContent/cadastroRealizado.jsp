...
<body>
  ...
  <h4>Você já pode acessar a página inicial e logar com seu usuário.</h4>
  <br>
  <a href="index.jsp"><input class="btn btn-info btn-lg" type="button" value="Pagina Inicial" name="btnHome"/></a>
  </div>
