		...
		<div class="container">
			<div class="panel-group">
				<div class="panel panel-primary">
					<div class="panel-heading">Cadastro de Cabo</div>
					...
					<div class="form-group">
						...
						<label for="tipo">Fabricante:</label><span style="color: red">*</span><select
							...
							<%
								CadastrarCaboController amc = new CadastrarCaboController();
					...
					<div align="center">
						<input class="btn btn-success btn-lg" type="button"
							value="Cadastrar Cabo" name="btnCadastrar" id="btnCadastrar">
					</div>
					<br>
				</div>
			</div>
