...
<script type="text/javascript">
	$(document).ready(function() {
		$('#btnAtribuirCabo').click(function(event) {
		...
		<div class="container">
			<div class="panel-group">
				<div class="panel panel-primary">
					<div class="panel-heading">Atribuição de Cabo</div>
					...
					<div class="form-group">
						...
						<label for="tipo">Tipo:</label><span style="color: red">*</span><select
							...
							<%
								AtribuirCaboController amc = new AtribuirCaboController();
								ArrayList<Cabo> tipos = amc.getTiposCabos();
					...
					<div align="center">
						<input class="btn btn-success btn-lg" type="button"
							value="Atribuir Cabo" name="btnAtribuirCabo"
							id="btnAtribuirCabo">
					</div>
					<br>
				</div>
