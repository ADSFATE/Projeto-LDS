...
<body>
	...
	<form name="formulario" id="formulario" action="AutenticacaoController" onsubmit="return validarForm()" method="post">

		<div align="center">

			<img alt="Locadora Logo" height="150" width="250"
				src="<%=request.getContextPath()%>/Images/logisticaglobo.jpg">
			<br> <br> <span>Login:</span><input type="text"
				name="txtLogin" id="txtLogin" placeholder="Seu login"> <br> <br>
			<span>Senha:</span><input type="password" maxlength="6" id="txtSenha"
				name="txtSenha" placeholder="Sua senha"> <br>
			<%
				if (request.getAttribute("errorMessage") != null) {
					out.print(
							"<span id='lbAviso' style='color:red'>" + request.getAttribute("errorMessage") + "</span><br>");
				} else {
			...
			<br> <input class="btn btn-success" type="submit" value="Entrar"
