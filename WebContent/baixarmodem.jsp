...
<body>
	...
	<form name="formulario" id="formulario"
		onsubmit="return validarForm();" action="BaixarModemController" method="post">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<div class="form-group">
			...
			<label for="tipo">Nº de Série:</label><span style="color:red">*</span><select class="form-control"
				id="cmbNserie" name="cmbNserie">
		...
		<div class="form-group">
			...
			<label for="txtCliente">Cliente:</label><span style="color:red">*</span><input class="form-control"
				type="text" id="txtCliente" autocomplete="off" name="txtCliente" value="" placeholder="Nome do Cliente">

		</div>

		<div class="form-group">

			<label for="txtNcircuito">Circuito:</label><span style="color:red">*</span> <input
				class="form-control" type="text" id="txtNcircuito" autocomplete="off"
		...
		<div class="form-group">
			...
			<label for="txtNRAT">Nº da RAT:</label><span style="color:red">*</span><input class="form-control"
				type="text" name="txtNRAT" id="txtNRAT" autocomplete="off" value="" placeholder="Número da RAT">

		</div>

		<div class="form-group">

			<label for="fileRATFrente">Imagem da RAT (Frente):</label><span style="color:red">*</span><input
		...
		<div class="form-group">
			...
			<label for="fileRATVerso">Imagem da RAT (Verso):</label><span style="color:red">*</span><input
				class="btn btn-default btn-file" data-buttonText="Find file"
		...
		<br> <br>
		<div align="center">
			<input class="btn btn-success btn-lg" type="submit" value="Baixar Modem"
				name="btnAtribuirModem">
